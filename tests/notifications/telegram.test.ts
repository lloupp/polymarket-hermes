...
describe('format functions', () => {
  ...
  it('formatCycleSummaryMessage includes all key metrics', () => {
    ...
    expect(msg).toContain('Cycle Report');
    expect(msg).toContain('2026-05-02 15:00 UTC');
  });

  it('formatCycleSummaryMessage includes wallet data when provided', () => {
    const msg = formatCycleSummaryMessage({
      runAt: '2026-05-02T15:00:00Z',
      totalMarkets: 20,
      weatherMarkets: 15,
    ...
    expect(msg).toContain('$1050.00');
    expect(msg).toContain('+5.0%');
    expect(msg).toContain('+$50.00');
  });

  it('formatCycleSummaryMessage includes win rate when provided', () => {
    const msg = formatCycleSummaryMessage({
      runAt: '2026-05-02T15:00:00Z',
      totalMarkets: 20,
      weatherMarkets: 15,
    ...
    expect(msg).toContain('1L');
  });

  it('formatCycleSummaryMessage includes inline signals', () => {
    const msg = formatCycleSummaryMessage({
      runAt: '2026-05-02T15:00:00Z',
      totalMarkets: 20,
      weatherMarkets: 15,
  ...
  it('formatCycleSummaryMessage shows red emoji for negative PnL', () => {
    const msg = formatCycleSummaryMessage({
      runAt: '2026-05-02T15:00:00Z',
      totalMarkets: 5,
      weatherMarkets: 5,
